  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Comprehensive HR Management System with employee management, payroll, attendance tracking, project management, and advanced analytics."
        />
        <meta
          property="og:title"
          content="ENIS-HRMS - Complete HR Management Solution"
        />
        <meta
          property="og:description"
          content="Streamline your HR processes with our enterprise-grade HRMS featuring advanced analytics, automated workflows, and comprehensive employee management."
        />
      </Helmet>
      <AuthProvider>
