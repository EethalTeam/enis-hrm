      ...
      <DialogContent className="glass-effect border-white/10 text-white">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">
            Log your work hours for a specific task.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => handleSelectChange("taskId", v)}
              required
...
const TimesheetsPage = () => {
  ...
  const timesheetStats = useMemo(() => {
    ...
    const uniqueProjects = new Set(timesheetEntries.map((e) => e.projectId))
      .size;
    return [
      {
        title: "Total Hours",
      ...
      {
        title: "Avg. Daily",
        value: totalHours > 0 ? `${(totalHours / 5).toFixed(1)}h` : "0.0h",
  ...
  const handleExportTimesheet = () =>
    toast({ title: "🚧 Feature Not Implemented" });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Track work hours, manage billable time, and generate comprehensive timesheet reports."
        />
      </Helmet>
                    ...
                    {timesheetEntries.map((entry, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td>
                            <span
                              className={`status-badge ${entry.status === "Approved" ? "status-active" : "status-pending"}`}
                            >
                              {entry.status}
                            </span>
                          </td>
