  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="View and manage employee leave balances."
        />
      </Helmet>
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <p className="text-gray-400">
            Overview of employee leave balances for the year.
          </p>
        </motion.div>
                  ...
                  <thead>
                    <tr>
                      ...
                      {LeaveBalance.length > 0 &&
                        LeaveBalance[0].leaveBalances.map((type) => (
                          <th key={type.leaveTypeId?.LeaveTypeName}>
                            {type.leaveTypeId?.LeaveTypeName}
                          </th>
                        ))}
                    </tr>
                  </thead>
