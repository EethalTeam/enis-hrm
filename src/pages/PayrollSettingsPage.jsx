  ...
  <Card className="glass-effect border-white/10">
    <CardHeader className="flex flex-row items-center justify-between">
      <div className="flex items-center gap-3">
        <Icon
          className={`w-6 h-6 ${componentType === "earnings" ? "text-green-400" : "text-red-400"}`}
        />
...
const PayrollSettingsPage = () => {
  ...
  const handleSave = (componentData) => {
    const dataToSave = {
      ...componentData,
      value: parseFloat(componentData.value),
    };
    if (selectedComponent) {
      updatePayrollComponent(componentType, {
        ...dataToSave,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Manage payroll masters including earnings and deductions."
        />
      </Helmet>
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <p className="text-gray-400">
            Manage payroll masters for earnings and deductions.
          </p>
        </motion.div>
