  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="glass-effect border-white/10 text-white">
        <DialogHeader>
          <DialogTitle>
            {projectStatus ? "Edit Project Status" : "Add New Project Status"}
          </DialogTitle>
        </DialogHeader>
      ...
      <AnimatePresence>
        {isFormOpen && (
          <ProjectStatusForm
            ...
            projectStatus={selectedProjectStat}
        ...
        >
          <div>
            ...
            <p className="text-gray-400">
              Manage your company's project status.
            </p>
          </div>
          <Button
                        ...
                        <td>
                          <div className="flex gap-2">
                            <Button
                              ...
                              variant="ghost"
                              className="h-8 w-8"
                              onClick={() => handleEdit(projectStat)}
                            >
                            ...
                            <Button
                              ...
                              onClick={() => handleDelete(projectStat._id)}
                            >
