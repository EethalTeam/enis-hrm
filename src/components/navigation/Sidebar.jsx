...
const navItems = [
  ...
  { icon: MessageSquare, label: "ClientManagement", path: "/client" },
];
    ...
    >
        ...
        <div className="flex items-center gap-3 p-4 mb-6">
          ...
          >
            <img
              class="h-10 w-10"
              alt="HRMS Logo"
              src="https://images.unsplash.com/photo-1579424471975-46ac8089543b"
            />
          </motion.div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <motion.button
          ...
          className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-300 hover:bg-red-500/80 hover:text-white transition-all duration-200"
        >
